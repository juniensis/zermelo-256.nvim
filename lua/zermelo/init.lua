---@type Zermelo.Util
local util = require("zermelo.util")
---@type Zermelo.Colours
local colours = require("zermelo.colours")
---@type Zermelo.Highlighter
local highlights = require("zermelo.highlights")
...
M.load = function()
	local palette = colours.generate_palette()
